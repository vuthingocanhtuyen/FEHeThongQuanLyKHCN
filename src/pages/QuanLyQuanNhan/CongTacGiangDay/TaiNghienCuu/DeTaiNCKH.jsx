...
const DeTaiNCKH = () => {
    ...
    return (
        <div>
            ...
            {/* Thêm tham số */}
            <ModalComponent forceRender title="Thêm đề tài nghiên cứu khoa học " open={isModalOpen} onCancel={handleCancel} footer={null} width="80%">
