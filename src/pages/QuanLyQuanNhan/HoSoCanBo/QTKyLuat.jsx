...
const QTKyLuat = () => {
    ...
    return (
        <div>
            ...
            {/* Thêm tham số */}
            <ModalComponent forceRender title="Thêm quá trình kỷ luật" open={isModalOpen} onCancel={handleCancel} footer={null} width="80%">
            ...
            <DrawerComponent title='Cập nhật quá trình kỷ luật' isOpen={isOpenDrawer} onClose={() => setIsOpenDrawer(false)} width="90%">
            ...
            <ModalComponent title="Xóa quá trình kỷ luật" open={isModalOpenDelete} onCancel={handleCancelDelete} onOk={handleDeleteProduct}>
