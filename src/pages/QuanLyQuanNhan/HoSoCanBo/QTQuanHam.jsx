...
const QTQuanHam = () => {
    ...
    return (
        <div>
            ...
            {/* Thêm tham số */}
            <ModalComponent forceRender title="Thêm quá trình quân hàm" open={isModalOpen} onCancel={handleCancel} footer={null} width="80%">
            ...
            <DrawerComponent title='Cập nhật quá trình quân hàm' isOpen={isOpenDrawer} onClose={() => setIsOpenDrawer(false)} width="90%">
