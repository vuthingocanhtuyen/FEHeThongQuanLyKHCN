...
const HoSoCanBo = () => {
    ...
    return (
        <div>
            <WrapperHeader>Quản lý cán bộ giáo viên</WrapperHeader>
            ...
            <ModalComponent forceRender title="Thêm cán bộ cá nhân" open={isModalOpen} onCancel={handleCancel} footer={null}>
